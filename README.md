...
<br />
<h2> Callenges </h2>
One of the callenges I had working on this app was that it took me a long time to figure out the type of API and data I was working with. I order to overcome this I had to step back and learn a bit more about Pokemons in general which then helped me working with the data structures and end point of the API.
